// Create a gpu-enabled linux vm, in the free tier of vms (the disks are billable)
//
...
//
param dateId string = '20231231c'

@description('Name of the virtual machine.')
param vmName string = 'training-${dateId}'

@description('Name for the Public IP used to access the Virtual Machine.')
param publicIpName string = 'pubIp-${dateId}'
